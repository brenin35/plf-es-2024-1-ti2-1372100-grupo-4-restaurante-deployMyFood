...
O cardápio digital apresentou um aumento significativo de uso desde a pandemia segundo a CNN Brasil,em que os cardápios em QR Code salvaram os restaurantes, como uma alternativa até então não muito explorada, e, grande  parte da população já apresenta preferência por eles por conta da praticidade e segurança que trazia na época.
